...
export const toggleAutoToMkv = (id: number) => api.post(`/media/${id}/toggle-auto-to-mkv`)
export const toggleAutoToSymlink = (id: number) => api.post(`/media/${id}/toggle-auto-to-symlink`)
export const setAutoTransition = (id: number, flags: { disableAutoToMkv?: boolean; disableAutoToSymlink?: boolean }) => api.put(`/media/${id}/auto-transition`, flags)
